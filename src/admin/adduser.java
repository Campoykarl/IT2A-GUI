...
public class adduser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(user, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 380, 40));
        ...
        jPanel1.add(fna, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 130, 380, 40));
        ...
        jPanel1.add(lna, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 180, 380, 40));

        jLabel2.setFont(new java.awt.Font("Bodoni MT", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("User Status:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 510, -1, 20));
        ...
        jPanel1.add(ct, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 230, 380, 40));
        ...
        jPanel1.add(address, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 280, 380, 40));
        ...
        jPanel1.add(cpass, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 380, 380, 40));
        ...
        jPanel1.add(status, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 500, 380, 40));

        jLabel10.setFont(new java.awt.Font("Bodoni MT", 1, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Password:");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, -1, 20));
        ...
        jPanel1.add(ps1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 330, 380, 40));
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 450, -1, 20));
        ...
        jPanel1.add(type1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 440, 380, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (user.getText().isEmpty() || ps1.getText().isEmpty() || address.getText().isEmpty()  || ct.getText().isEmpty() || fna.getText().isEmpty() || lna.getText().isEmpty()) {
            ...
            dbConnect dbc = new dbConnect();
            int rowsAffected = dbc.insertData(status.getSelectedItem()+"INSERT INTO tbl_user(u_fname, u_lname, u_user, u_pass, u_contact, u_address, u_type, u_status) " +
                    "VALUES('" + fna.getText() + "','" + lna.getText() + "','" + user.getText() + "', '" + ps1.getText() + "', '" + ct.getText() + "','" + address.getText() + "', '" + status.getSelectedItem() + "', '')");
